...
* [Questionnaire](https://github.com/netzahdzc/oHealth-Context/blob/master/schemas/entity/questionnaire-1.x.json)
...
* [Systolic blood pressure](https://github.com/netzahdzc/oHealth-Context/blob/master/schemas/dataType/systolic_blood_pressure-1.x.json)
* [Diastolic blood pressure](https://github.com/netzahdzc/oHealth-Context/blob/master/schemas/dataType/diastolic_blood_pressure-1.x.json)
* [Date time](https://github.com/netzahdzc/oHealth-Context/blob/master/schemas/dataType/date-time-1.x.json)
* [Name](https://github.com/netzahdzc/oHealth-Context/blob/master/schemas/dataType/name-1.x.json)
* [Surname](https://github.com/netzahdzc/oHealth-Context/blob/master/schemas/dataType/surname-1.x.json)
...
* [Status](https://github.com/netzahdzc/oHealth-Context/blob/master/schemas/dataType/status-1.x.json)
* [E-mail](https://github.com/netzahdzc/oHealth-Context/blob/master/schemas/dataType/email-1.x.json)
* [Activation code](https://github.com/netzahdzc/oHealth-Context/blob/master/schemas/dataType/activation-code-1.x.json)
* [Test identification](https://github.com/netzahdzc/oHealth-Context/blob/master/schemas/dataType/test-identification-1.x.json)
* [Patient identification](https://github.com/netzahdzc/oHealth-Context/blob/master/schemas/dataType/patient-identification-1.x.json)
